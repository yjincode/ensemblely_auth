...
import spring.authservice.grpc.UserInfoServiceGrpc;
import spring.authservice.grpc.UserIdRequest;
import spring.authservice.grpc.UserNicknameResponse;
import spring.authservice.grpc.UserIdsRequest;
import spring.authservice.grpc.UserNicknamesResponse;
import spring.authservice.grpc.UserDisplayInfoResponse;
...
public class UserInfoGrpcServiceImpl extends UserInfoServiceGrpc.UserInfoServiceImplBase {
    ...
    private final UserRepository userRepository; // Keep for findAllById until added to port
    ...
    public void getUserNickname(UserIdRequest request, StreamObserver<UserNicknameResponse> responseObserver) {
        try {
            ...
            Optional<User> userOptional = userPersistencePort.findById(request.getUserId());
